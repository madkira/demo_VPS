...
void Backbone_send_Output_nothing(struct Backbone_Instance *_instance);
...
void (*external_Backbone_send_Output_nothing_listener)(struct Backbone_Instance *)= 0x0;
void (*Backbone_send_Output_nothing_listener)(struct Backbone_Instance *)= 0x0;
void register_external_Backbone_send_Output_nothing_listener(void (*_listener)(struct Backbone_Instance *)){
external_Backbone_send_Output_nothing_listener = _listener;
}
void register_Backbone_send_Output_nothing_listener(void (*_listener)(struct Backbone_Instance *)){
Backbone_send_Output_nothing_listener = _listener;
}
void Backbone_send_Output_nothing(struct Backbone_Instance *_instance){
if (Backbone_send_Output_nothing_listener != 0x0) Backbone_send_Output_nothing_listener(_instance);
if (external_Backbone_send_Output_nothing_listener != 0x0) external_Backbone_send_Output_nothing_listener(_instance);
;
}
