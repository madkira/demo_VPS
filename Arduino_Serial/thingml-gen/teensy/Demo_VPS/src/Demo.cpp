...
void Demo_send_serial1sender_calibrating(struct Demo_Instance *_instance);
void Demo_send_serial1sender_play(struct Demo_Instance *_instance);
//Prototypes: Function
...
Demo_send_serial1sender_play(_instance);
...
if (_instance->Demo_alpha_State == DEMO_ALPHA_IDLE_STATE) {
if (Demo_alpha_State_event_consumed == 0 && 1) {
Demo_send_serial1sender_calibrating(_instance);
Demo_alpha_State_event_consumed = 1;
}
}
//End Region alpha
...
void (*external_Demo_send_serial1sender_calibrating_listener)(struct Demo_Instance *)= 0x0;
void (*Demo_send_serial1sender_calibrating_listener)(struct Demo_Instance *)= 0x0;
void register_external_Demo_send_serial1sender_calibrating_listener(void (*_listener)(struct Demo_Instance *)){
external_Demo_send_serial1sender_calibrating_listener = _listener;
}
void register_Demo_send_serial1sender_calibrating_listener(void (*_listener)(struct Demo_Instance *)){
Demo_send_serial1sender_calibrating_listener = _listener;
}
void Demo_send_serial1sender_calibrating(struct Demo_Instance *_instance){
if (Demo_send_serial1sender_calibrating_listener != 0x0) Demo_send_serial1sender_calibrating_listener(_instance);
if (external_Demo_send_serial1sender_calibrating_listener != 0x0) external_Demo_send_serial1sender_calibrating_listener(_instance);
;
}
void (*external_Demo_send_serial1sender_play_listener)(struct Demo_Instance *)= 0x0;
void (*Demo_send_serial1sender_play_listener)(struct Demo_Instance *)= 0x0;
void register_external_Demo_send_serial1sender_play_listener(void (*_listener)(struct Demo_Instance *)){
external_Demo_send_serial1sender_play_listener = _listener;
}
void register_Demo_send_serial1sender_play_listener(void (*_listener)(struct Demo_Instance *)){
Demo_send_serial1sender_play_listener = _listener;
}
void Demo_send_serial1sender_play(struct Demo_Instance *_instance){
if (Demo_send_serial1sender_play_listener != 0x0) Demo_send_serial1sender_play_listener(_instance);
if (external_Demo_send_serial1sender_play_listener != 0x0) external_Demo_send_serial1sender_play_listener(_instance);
;
}
